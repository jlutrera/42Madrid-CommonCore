 ...
 - [get_next_line]: Function that returns a line from a file descriptor.
 - [Born2beroot]: Systems administration exercise.
 - [push_swap]: Stack sorting with minimal operations.
 - [Minitalk]: Data exchange via UNIX signals.
 - [FDF]: 3D wireframe rendering.
 - [philosophers]: Threads and mutex synchronization.
...
y sin formato:
 ...
 - [miniRT]: Basic ray tracing renderer.
 - [NetPractice]: Networking exercises.
 - [CPP 00_04]: C++ modules 00–04.
 - [CPP 05_09]: C++ modules 05–09.
...
```
 ...
 - [ft_transcendence]: Full web application for Pong contest.
