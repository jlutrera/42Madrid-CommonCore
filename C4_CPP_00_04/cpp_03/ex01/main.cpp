...
/*   Updated: 2023/08/31 10:46:21 by jutrera-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << std::endl;
	std::cout << YELLOW + "Probamos el objeto <jane> (que es copia de <joe> al inicio) de la clase <ScavTrap>" + RESET << std::endl;
	...
	std::cout << std::endl;
	std::cout << YELLOW + "Probamos el objeto <peter> (que se iguala a <joe> en este momento) de la clase <ScavTrap>" + RESET << std::endl;
	peter = joe;
