...
En la última versión he añadido un flag (-v) que muestra el programa como lo tenía.  Sin este flag se muestra el texto sin tanto formato, ganando en tiempo de ejecución y funcionando mejor el algoritmo.
